...
export function DashboardCard({ id, title, widgets = [], created_at }: DashboardCardProps) {
  ...
  return (
    <Link href={`/app/${id}`}>
      <div className="group cursor-pointer rounded-md border bg-card transition-all duration-300 overflow-hidden h-80 flex flex-col">
        {/* Chart Preview */}
